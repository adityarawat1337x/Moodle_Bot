...
_______▒__________▒▒▒▒▒▒▒▒▒▒▒▒▒▒				 just kidding if you dont want mozilla firefox and you are a chrome lover then go kill yourself..
______▒_______________▒▒▒▒▒▒▒▒					 anyways then you have to download chrome driver(google it:chrome driver for selenium) and add path to (line 44)
_____▒________________▒▒▒▒▒▒▒▒					 plus change the comment on (line 2) and comment out (line 1)*
____▒___________▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒
___▒
__▒______▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
_▒______▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓▒▓
